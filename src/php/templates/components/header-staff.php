        ...
        <div class="container-fluid">
            ...
            <div class="collapse navbar-collapse" id="navbarNav">
                <ul class="navbar-nav ms-auto">
                    <li class="nav-item"><a class="nav-link <?php echo is_active_page('staff-dashboard'); ?>" href="<?php echo get_page_url('staff-dashboard'); ?>">Dashboard</a></li>
                    <li class="nav-item"><a class="nav-link <?php echo is_active_page('staff-job'); ?>" href="<?php echo get_page_url('staff-job'); ?>">Jobs</a></li>
